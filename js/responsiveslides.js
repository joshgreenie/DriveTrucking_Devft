...
(function (c, I, B) {
    c.fn.responsiveSlides = function (l) {
        ...
        return this.each(function () {
            B++;
            var f = c(this), s, r, t, m, p, q, n = 0, e = f.children(), C = e.size(), h = parseFloat(a.speed), D = parseFloat(a.timeout), u = parseFloat(a.maxwidth), g = a.namespace, d = g + B, E = g + "_nav " + d + "_nav", v = " current", j = d + "_on",
            ...
            if (1 < e.size()) {
                ...
                if (a.nav) {
                    g = "<a href='#' class='" + E + " prev icon-box-left'>" + a.prevText + "</a><a href='#' class='" + E + " next icon-box-left'>" + a.nextText + "</a>";
