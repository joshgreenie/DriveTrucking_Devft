...
$salary_range = preg_replace('/\s*/', '', $salary_range);
$salary_range = strtolower($salary_range);
$salary_range = "salary_range-".$salary_range;


$experience_range			= get_field('years_of_experience');
$experience_range = preg_replace('/\s*/', '', $experience_range);
$experience_range = strtolower($experience_range);
$experience_range = "experience_range-".$experience_range;

?>
<article id="post-<?php the_ID(); ?>" <?php post_class("$experience_range"); ?> itemscope itemtype="http://schema.org/JobPosting">
